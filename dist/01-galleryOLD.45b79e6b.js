...
})({"2dAQa":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a6ecf36945b79e6b";
...
},{}],"4UDX0":[function(require,module,exports) {
var _galleryItemsJs = require("./gallery-items.js");
// Change code below this line
console.log((0, _galleryItemsJs.galleryItems));
const galleryEl = document.querySelector(".gallery");
let instance;
const galleryContainer = (0, _galleryItemsJs.galleryItems).map((image)=>`<div class="gallery__item">
...
function eventGallery(event) {
    ...
    <img src="${event.target.dataset.source}" alt="${event.target.alt}" />`, {
        ...
        instance.show((instance1)=>console.log("finished show()", instance1));
    }
}
function test(event) {
    console.log(event);
...
},{}]},["2dAQa","4UDX0"], "4UDX0", "parcelRequire4c75")

//# sourceMappingURL=01-galleryOLD.45b79e6b.js.map
